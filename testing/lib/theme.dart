...
Color tersierTextColor = Color.fromARGB(255, 255, 0, 0);
Color subtitleColor = Color(0xff504F5E);
Color transparentColor = Colors.transparent;
Color blackColor = Color(0xff2E2E2E);
Color tfcolor = Color(0xff00A3FF);
Color tfcolor1 = Color.fromARGB(255, 38, 0, 255);
TextStyle tfcolor1TextStyle = GoogleFonts.poppins(
  color: tfcolor1,
);
TextStyle primaryTextStyle = GoogleFonts.poppins(
  color: primaryTextColor,
);
TextStyle tersierTextStyle = GoogleFonts.poppins(
